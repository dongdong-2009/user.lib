...
<Project Type="Project" LVVersion="9008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="RWA VIs" Type="Folder">
			<Item Name="subVIs" Type="Folder" URL="../subVIs">
				<Property Name="NI.DISK" Type="Bool">true</Property>
			</Item>
			<Item Name="Read Anything (Merge).vi" Type="VI" URL="../Read Anything (Merge).vi"/>
			<Item Name="RWA Anything to String.vi" Type="VI" URL="../RWA Anything to String.vi"/>
			<Item Name="RWA String To Anything.vi" Type="VI" URL="../RWA String To Anything.vi"/>
			<Item Name="RWA Delete Section.vi" Type="VI" URL="../RWA Delete Section.vi"/>
			<Item Name="RWA List Sections.vi" Type="VI" URL="../RWA List Sections.vi"/>
			<Item Name="Write Anything.vi" Type="VI" URL="../Write Anything.vi"/>
		</Item>
		<Item Name="MGI Read-Write Anything.vipb" Type="Document" URL="../MGI Read-Write Anything.vipb"/>
		<Item Name="MGI Read-Write Anything.vipc" Type="Document" URL="../MGI Read-Write Anything.vipc"/>
		<Item Name="MGI_ReadWriteAnything_Release_Notes.txt" Type="Document" URL="../MGI_ReadWriteAnything_Release_Notes.txt"/>
